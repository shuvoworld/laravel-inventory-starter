...
<div class="card">
    ...
    <form method="POST" action="{{ route('modules.brand.update', $item->id) }}" onsubmit="this.querySelector('button[type=submit]').disabled=true;">
        @csrf
        @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="url" class="form-control @error('website') is-invalid @enderror"
                           id="website" name="website" value="{{ old('website', $item->website) }}" placeholder="https://example.com">
                    @error('website')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
