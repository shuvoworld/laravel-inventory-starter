        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input id="supplier_name" type="text" name="supplier_name" class="form-control @error('supplier_name') is-invalid @enderror" value="{{ old('supplier_name', $item->supplier_name) }}" required>
