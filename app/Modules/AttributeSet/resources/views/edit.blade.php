...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Edit Attribute Set</h1>
...
<div class="card">
    ...
    <form method="POST" action="{{ route('modules.attribute-set.update', $item->id) }}" onsubmit="this.querySelector('button[type=submit]').disabled=true;">
        @csrf
        @method('PUT')
