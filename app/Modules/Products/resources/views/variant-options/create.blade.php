...
<div class="d-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0">Create Variant Option</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('modules.products.variant-options.store') }}" method="POST">
            @csrf
                    ...
                    <div class="value-row mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="number"
                                       class="form-control"
                                       name="values[0][display_order]"
                                       value="0"
                                       placeholder="Order"
                                       min="0">
                            </div>
                            <div class="col-md-1">
                                <button type="button" class="btn btn-danger w-100" onclick="removeValue(this)" disabled>
                                    <i class="fas fa-times"></i>
                                </button>
                            </div>
                        </div>
...
@push('scripts')
<script>
let valueIndex = {{ old('values') ? count(old('values')) : 1 }};
