...
<div class="card">
    <div class="card-header">
        <h3 class="card-title mb-0">Edit {{ ucfirst(__('Product Category')) }}</h3>
    </div>
    <form method="POST" action="{{ route('modules.product-categories.update', $item->id) }}" onsubmit="this.querySelector('button[type=submit]').disabled=true;">
        @csrf
        @method('PUT')
        <div class="card-body form-minimal">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input id="slug" type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug', $item->slug) }}">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input id="sort_order" type="number" min="0" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror" value="{{ old('sort_order', $item->sort_order) }}">
                ...
                <div class="col-12">
                    <div class="alert alert-info mb-0">
                        <i class="fas fa-info-circle me-1"></i> This category has <strong>{{ $item->products()->count() }}</strong> product(s) associated with it.
                    </div>
                </div>
            </div>
        </div>
